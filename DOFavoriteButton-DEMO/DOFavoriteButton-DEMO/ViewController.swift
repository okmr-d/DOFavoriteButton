...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        starButton.addTarget(self, action: #selector(tappedButton), for: .touchUpInside)
        ...
        heartButton.addTarget(self, action: #selector(tappedButton), for: .touchUpInside)
        ...
        likeButton.addTarget(self, action: #selector(tappedButton), for: .touchUpInside)
        ...
        smileButton.addTarget(self, action: #selector(tappedButton), for: .touchUpInside)
        self.view.addSubview(smileButton)
        
        self.heartButton.addTarget(self, action: #selector(tappedButton), for: .touchUpInside)
    }
