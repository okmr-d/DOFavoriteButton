...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        starButton.addTarget(self, action: #selector(tappedButton(_:)), for: .touchUpInside)
        ...
        heartButton.addTarget(self, action: #selector(tappedButton(_:)), for: .touchUpInside)
        ...
        likeButton.addTarget(self, action: #selector(tappedButton(_:)), for: .touchUpInside)
        ...
        smileButton.addTarget(self, action: #selector(tappedButton(_:)), for: .touchUpInside)
        self.view.addSubview(smileButton)
        
        self.heartButton.addTarget(self, action: #selector(tappedButton(_:)), for: .touchUpInside)
    }
