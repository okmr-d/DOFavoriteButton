...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        starButton.addTarget(self, action: Selector("tappedButton:"), for: UIControlEvents.touchUpInside)
        ...
        heartButton.addTarget(self, action: Selector("tappedButton:"), for: UIControlEvents.touchUpInside)
        ...
        likeButton.addTarget(self, action: Selector("tappedButton:"), for: UIControlEvents.touchUpInside)
        ...
        smileButton.addTarget(self, action: Selector("tappedButton:"), for: UIControlEvents.touchUpInside)
        self.view.addSubview(smileButton)
        
        self.heartButton.addTarget(self, action: Selector("tappedButton:"), for: UIControlEvents.touchUpInside)
    }
